...
import FruitAutocomplete, { fruitAutocompleteRender } from '../FruitAutocomplete';
...
const hasItem = (wrapper, item) => wrapper.find(sel(`item-${item}`)).length === 1;
const renderFruitAutocompleteRenderer = props => render(fruitAutocompleteRender({ ...downshiftStub, ...props }));
